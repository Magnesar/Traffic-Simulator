...
ainit=15         // initial distance between all vehicles
...
while j<50                         //value of j=time in seconds
    ...
    //reqriting the values in the matrices with the newer values
    for i=1:N
        V(i)=[v(i)]                     //v_n after j seconds
        D(i)=[d(i)/ainf]              //a_n  after j seconds
        X(i)=[x(i)]                     //x_n after j seconds
